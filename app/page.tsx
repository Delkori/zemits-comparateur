...
export default function Home() {
  const categories = [
    ...
    { slug: 'Cryotherapie', label: 'Cryothérapie', icon: '❄️', desc: 'Lifting et raffermissement par le froid' },
    { slug: 'Cavitation', label: 'Cavitation', icon: '🔊', desc: 'Remodelage corporel par ultrasons' },
    { slug: 'Haute frequence', label: 'Haute Fréquence', icon: '✨', desc: 'Anti-acné et cicatrisation accélérée' },
    { slug: 'Multiplex', label: 'Multiplex / Combo', icon: '🔬', desc: 'Machines tout-en-un multifonctions' },
  ]
  ...
  const avantages = [
    ...
    { icon: '🔧', title: 'Garantie 2 ans', desc: "Pièces et main-d'oeuvre" },
  ]
  ...
  return (
    <main className="min-h-screen bg-[#f8f4ef]">
      ...
      <section className="bg-[#1a1a2e] text-white py-24 px-8 text-center">
        <p className="text-[#C9A84C] font-semibold mb-3 tracking-widest uppercase text-sm">No 1 en France</p>
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          Comparez les meilleures<br/>
          <span className="text-[#C9A84C]">machines esthetiques</span>
        </h1>
        <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
          Zemits face aux leaders du marche - specifications, technologies, prix, garantie
        </p>
        <Link href="/comparateur" className="bg-[#C9A84C] text-[#1a1a2e] px-10 py-4 rounded-xl text-lg font-bold hover:bg-yellow-400 transition inline-block shadow-lg">
          Lancer le comparateur
        </Link>
      </section>

      <section className="py-20 px-8 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12 text-[#1a1a2e]">Choisissez votre categorie</h2>
