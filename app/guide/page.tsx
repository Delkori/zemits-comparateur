...
const STEPS = [
  {
    ...
    options: [
      { value: "visage", label: "Soins du visage", desc: "Nettoyage, anti-age, eclat" },
      { value: "corps", label: "Remodelage corporel", desc: "Minceur, cellulite, galbe" },
      { value: "acne", label: "Traitement acne", desc: "Anti-imperfections, cicatrices" },
      { value: "polyvalent", label: "Polyvalent tout usage", desc: "Plusieurs soins a la fois" },
    ]
  },
  {
    id: "usage",
    ...
    options: [
      { value: "faible", label: "Occasionnelle", desc: "Moins de 5 clients / jour" },
      { value: "moyen", label: "Reguliere", desc: "5 a 15 clients / jour" },
      { value: "intense", label: "Intensive", desc: "Plus de 15 clients / jour" },
    ]
  },
  {
    id: "budget",
    ...
    options: [
      { value: "petit", label: "Moins de 3 000 EUR", desc: "Debutant ou complement" },
      { value: "moyen", label: "3 000 - 8 000 EUR", desc: "Professionnel confirme" },
      { value: "grand", label: "8 000 - 20 000 EUR", desc: "Centre premium" },
      { value: "top", label: "Plus de 20 000 EUR", desc: "Clinique haut de gamme" },
    ]
  },
  {
    id: "experience",
    ...
    options: [
      { value: "non", label: "Non, premier achat", desc: "Je decouvre ce secteur" },
      { value: "oui_basique", label: "Oui, je veux upgrader", desc: "Machine basique actuelle" },
      { value: "oui_pro", label: "Oui, je complete mon parc", desc: "Je cherche un complement" },
    ]
  }
]

const ZEMITS_RECO: Record<string, { nom: string; prix: string; tech: string; garantie: string; badge: string; roi: string }> = {
    ...
    return (
      <main className="min-h-screen bg-[#f8f4ef] flex items-center justify-center px-4">
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center max-w-lg w-full">
          ...
          <p className="text-gray-500 mb-2">Notre expert Zemits vous contacte sous <strong>24h</strong>.</p>
      ...
      <main className="min-h-screen bg-[#f8f4ef] flex items-center justify-center px-4 py-10">
        <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-lg w-full">
          <div className="text-center mb-8">
            <div className="inline-block bg-[#C9A84C] text-[#1a1a2e] text-xs font-bold px-3 py-1 rounded-full mb-3 uppercase">
              Devis personnalise
            </div>
          ...
          <form onSubmit={submitDevis} className="space-y-4">
            ...
            <div>
              ...
              <input type="text" value={form.centre} onChange={(e) => setForm({...form, centre: e.target.value})}
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="text-center mb-10">
            <div className="inline-block bg-green-100 text-green-700 text-sm font-bold px-4 py-2 rounded-full mb-4">
              Analyse complete - Machine ideale trouvee
            </div>
            <h1 className="text-3xl font-bold text-[#1a1a2e]">Votre recommandation</h1>
          </div>
          <div className="grid gap-6">
              ...
              <div className="p-8">
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  <div className="flex-1">
                    <div className="text-xs text-[#C9A84C] font-bold uppercase tracking-wide mb-1">ZEMITS</div>
                    ...
                    <div className="flex flex-wrap gap-3 mb-4">
                      ...
                      <span className="bg-orange-50 text-orange-700 text-xs font-semibold px-3 py-1 rounded-full">ROI : {reco.roi}</span>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow p-6">
              <h3 className="font-bold text-[#1a1a2e] mb-4 text-sm uppercase tracking-wide text-gray-500">Comparatif concurrence</h3>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-100">
                      ...
                      <th className="text-center py-3 text-gray-500 font-semibold">Avis</th>
  ...
  return (
    <main className="min-h-screen bg-[#f8f4ef]">
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        {step > 0 && (
          <button onClick={() => setStep(step - 1)} className="mt-6 text-sm text-gray-400 hover:text-gray-600 underline w-full text-center">
            Etape precedente
          </button>
        )}
      </div>
